...
export default function DigitalCircuits() {
  ...
  const courseInfo = {
    ...
    description: "Learn the fundamentals of digital electronics. Understand logic gates, circuit design, and how to build and analyze digital systems."
  };
  ...
  const courseContent: CourseContent[] = [
    {
      ...
      type: "video",
      duration: "12:00",
      description: "Overview of digital systems and binary logic",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "20 min",
      description: "Learn about basic logic gates and their operations",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "15:30",
      description: "Design and analyze combinational logic circuits",
      completed: false,
    },
    {
      ...
      type: "exercise",
      duration: "25 min",
      description: "Work with flip-flops and sequential logic",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "18 min",
      description: "Understand different types of memory and storage circuits",
      completed: false,
    },
    {
      title: "Final Project: Digital Clock",
      type: "project",
      duration: "45 min",
      description: "Design and implement a digital clock circuit",
      completed: false,
    }
  ];
  ...
  const learningPoints = [
    "Master digital logic and Boolean algebra",
    "Design and analyze combinational circuits",
    "Work with sequential logic and flip-flops",
    "Understand memory and storage systems",
    "Build practical digital circuits"
  ];
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}> 
          ...
          <View style={styles.bannerContent}>
            <Text style={styles.bannerTitle}>Digital Circuits</Text>
            <Text style={styles.bannerSubtitle}>Master Digital Electronics</Text>
          </View>
        </View>
