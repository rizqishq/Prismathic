...
export default function SearchEngines() {
  ...
  const courseInfo = {
    ...
    description: "Learn how search engines work, their algorithms, and how to optimize content for better search results. Understand the technology behind modern search systems."
  };
  ...
  const courseContent: CourseContent[] = [
    {
      ...
      type: "video",
      duration: "12:00",
      description: "Overview of search engine technology and history",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "25 min",
      description: "Learn about ranking algorithms and search methodologies",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "15:30",
      description: "Understand how search engines gather and organize information",
      completed: false,
    },
    {
      ...
      type: "exercise",
      duration: "30 min",
      description: "Learn techniques to improve content visibility",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "20 min",
      description: "Explore advanced search capabilities and features",
      completed: false,
    },
    {
      title: "Final Project: Search Engine Analysis",
      type: "project",
      duration: "45 min",
      description: "Analyze and optimize a website for search engines",
      completed: false,
    }
  ];
  ...
  const learningPoints = [
    "Understand search engine technology",
    "Master search algorithms and ranking",
    "Learn web crawling and indexing",
    "Apply search engine optimization",
    "Analyze and improve search results"
  ];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}> 
          <FontAwesome5 name="search" size={60} color="#000" style={styles.bannerIcon} />
          <View style={styles.bannerContent}>
            <Text style={styles.bannerTitle}>Search Engines</Text>
            <Text style={styles.bannerSubtitle}>Master Search Technology</Text>
          </View>
        </View>
