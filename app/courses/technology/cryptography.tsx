...
export default function Cryptography() {
  ...
  const courseInfo = {
    ...
    description: "Learn the principles of cryptography, encryption algorithms, and security protocols. Understand how to protect data and communications in the digital age."
  };
  ...
  const courseContent: CourseContent[] = [
    {
      ...
      type: "video",
      duration: "15:00",
      description: "Overview of cryptography and its importance",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "25 min",
      description: "Learn about historical encryption methods",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "20:30",
      description: "Study of symmetric and asymmetric encryption",
      completed: false,
    },
    {
      ...
      type: "exercise",
      duration: "35 min",
      description: "Implement and analyze security protocols",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "25 min",
      description: "Understand digital authentication methods",
      completed: false,
    },
    {
      title: "Final Project: Secure Communication System",
      type: "project",
      duration: "60 min",
      description: "Design and implement a secure messaging system",
      completed: false,
    }
  ];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}> 
          <FontAwesome5 name="lock" size={60} color="#000" style={styles.bannerIcon} />
          <View style={styles.bannerContent}>
            <Text style={styles.bannerTitle}>Cryptography</Text>
            <Text style={styles.bannerSubtitle}>Master Digital Security</Text>
          </View>
        </View>
