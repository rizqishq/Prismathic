...
export default function ProgrammingVariables() {
  ...
  const courseInfo = {
    ...
    description: "Learn the fundamental concept of variables in programming. Understand how to declare, assign, and manipulate variables to store and manage data in your programs."
  };
  ...
  const courseContent: CourseContent[] = [
    {
      ...
      type: "video",
      duration: "10:15",
      description: "Understanding what variables are and why we use them",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "12:30",
      description: "Exploring different data types and their uses",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "15 min",
      description: "Learning how to declare variables in different languages",
      completed: false,
    },
    {
      title: "Practice: Variable Types",
      type: "exercise",
      duration: "20 min",
    ...
    },
    {
      ...
      type: "reading",
      duration: "18 min",
      description: "Performing operations with variables",
      completed: false,
    },
    {
      title: "Practice: Variable Operations",
      type: "exercise",
      duration: "25 min",
      description: "Applying variable operations in practice",
      completed: false,
    },
    {
      title: "Final Project",
      type: "project",
      duration: "40 min",
      description: "Create a program using various variable types and operations",
      completed: false,
    }
  ];
  ...
  const learningPoints = [
    ...
    "Master different variable types and their uses",
    "Learn proper variable declaration and naming",
    "Understand variable scope and lifetime",
    "Apply variable operations in practical scenarios"
  ];
