...
export default function HowAIWorks() {
  ...
  const courseContent: CourseContent[] = [
    ...
    {
      title: "Practice: ML Classification",
      type: "exercise",
      duration: "25 min",
      description: "Hands-on with basic classification tasks",
      completed: false,
    },
    {
    ...
    },
    {
      ...
      type: "reading",
      duration: "22 min",
      description: "Exploring deep learning architectures",
      completed: false,
    },
    {
      title: "Practice: Building Neural Networks",
      type: "exercise",
      duration: "30 min",
      description: "Creating simple neural network models",
      completed: false,
    },
    {
      title: "Final Project",
  ...
  const learningPoints = [
    ...
    "Master the basics of neural networks and deep learning",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}>
          <FontAwesome5 name="robot" size={60} color="#000" style={styles.bannerIcon} />
          <View style={styles.bannerContent}>
            <Text style={styles.bannerTitle}>Programming & CS</Text>
            <Text style={styles.bannerSubtitle}>Master artificial intelligence</Text>
          </View>
        </View>
