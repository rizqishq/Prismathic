...
export default function LinearAlgebra() {
  ...
  const courseInfo = {
    ...
    description: "Master the fundamentals of linear algebra, including vectors, matrices, linear transformations, and their applications in various fields."
  };
  ...
  const courseContent: CourseContent[] = [
    {
      ...
      type: "video",
      duration: "20:00",
      description: "Basic concepts of vectors and matrices",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "30 min",
      description: "Understanding vector spaces and their properties",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "25:30",
      description: "Study of linear transformations and their matrices",
      completed: false,
    },
    {
      ...
      type: "exercise",
      duration: "40 min",
      description: "Working with eigenvalues and eigenvectors",
      completed: false,
    },
    {
      title: "Applications in Computer Graphics",
      type: "reading",
      duration: "35 min",
      description: "Using linear algebra in computer graphics",
      completed: false,
    },
    {
      title: "Final Project: Matrix Operations",
      type: "project",
      duration: "90 min",
      description: "Implement and analyze matrix operations",
      completed: false,
    }
  ];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}> 
          <FontAwesome5 name="vector-square" size={60} color="#000" style={styles.bannerIcon} />
          <View style={styles.bannerContent}>
            <Text style={styles.bannerTitle}>Linear Algebra</Text>
            <Text style={styles.bannerSubtitle}>Master Vector Spaces</Text>
          </View>
        </View>
