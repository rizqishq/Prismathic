...
export default function BasicAlgebra() {
  ...
  const courseInfo = {
    ...
    description: "Master the fundamentals of algebra including variables, equations, and expressions. Learn how to solve basic algebraic problems and build a strong foundation for advanced mathematics."
  };
  ...
  const courseContent: CourseContent[] = [
    ...
    },
    {
      ...
      type: "reading",
      duration: "15 min",
      description: "Learn to solve simple linear equations",
      completed: false,
    },
    {
      ...
      type: "exercise",
      duration: "20 min",
      description: "Hands-on exercises with basic algebraic equations",
      completed: false,
    },
    {
      title: "Word Problems",
      type: "video",
      duration: "15:45",
      description: "Converting word problems into algebraic equations",
      completed: false,
    },
    {
      title: "Inequalities",
      type: "reading",
      duration: "18 min",
      description: "Understanding and solving algebraic inequalities",
      completed: false,
    },
    {
      ...
      type: "exercise",
      duration: "25 min",
      description: "Applying inequality concepts to solve problems",
      completed: false,
    },
    {
  ...
  const learningPoints = [
    ...
    "Convert word problems into algebraic form",
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}>
          ...
          <View style={styles.bannerContent}>
            ...
            <Text style={styles.bannerSubtitle}>Master algebraic concepts</Text>
          </View>
        </View>
