...
export default function ScientificThinking() {
  ...
  const courseInfo = {
    ...
    description: "Learn the foundations of scientific thinking. Explore the scientific method, critical analysis, and how to approach problems like a scientist."
  };

  const courseContent: CourseContent[] = [
    {
      title: "What is Scientific Thinking?",
      type: "video",
      duration: "10:00",
      description: "Introduction to the concept and importance of scientific thinking",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "12:30",
      description: "Step-by-step breakdown of the scientific method",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "15 min",
      description: "How to analyze information and arguments critically",
      completed: false,
    },
    {
      title: "Practice: Formulating Hypotheses",
      type: "exercise",
      duration: "20 min",
      description: "Hands-on activity to create and test hypotheses",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "14:00",
      description: "How to design effective scientific experiments",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "18 min",
      description: "Understanding and interpreting scientific data",
      completed: false,
    },
    {
      title: "Practice: Analyzing Results",
      type: "exercise",
      duration: "25 min",
      description: "Analyze sample data and draw conclusions",
      completed: false,
    },
    {
      title: "Final Project",
      type: "project",
      duration: "40 min",
      description: "Apply scientific thinking to solve a real-world problem",
      completed: false,
    }
  ];
  ...
  const learningPoints = [
    ...
    "Learn to design experiments and interpret data",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}>
          <FontAwesome5 name="microscope" size={60} color="#000" style={styles.bannerIcon} />
          <View style={styles.bannerContent}>
            <Text style={styles.bannerTitle}>Science</Text>
            <Text style={styles.bannerSubtitle}>Think like a scientist</Text>
          </View>
        </View>
