...
export default function EverydayTech() {
  ...
  const courseInfo = {
    ...
    description: "Understand the technology that surrounds us. Learn about digital devices, networks, and how to think logically about everyday technology."
  };

  const courseContent: CourseContent[] = [
    {
      title: "Introduction to Everyday Technology",
      type: "video",
      duration: "10:00",
      description: "Overview of common technologies and their impact",
      completed: false,
    },
    {
      title: "Digital Devices and Systems",
      type: "reading",
      duration: "15 min",
      description: "Learn about the devices we use daily and how they work",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "12:30",
      description: "Understand how devices communicate and share information",
      completed: false,
    },
    {
      ...
      type: "exercise",
      duration: "20 min",
      description: "Practice troubleshooting common technology issues",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "18 min",
      description: "Learn essential security practices for digital devices",
      completed: false,
    },
    {
      title: "Final Project: Tech Solution Design",
      type: "project",
      duration: "35 min",
      description: "Design a solution for a common technology problem",
      completed: false,
    }
  ];
  ...
  const learningPoints = [
    "Understand common digital devices and systems",
    "Master basic network concepts",
    "Develop tech troubleshooting skills",
    "Learn essential digital security practices",
    "Apply logical thinking to technology problems"
  ];
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}> 
          ...
          <View style={styles.bannerContent}>
            <Text style={styles.bannerTitle}>Everyday Tech</Text>
            <Text style={styles.bannerSubtitle}>Understanding Modern Technology</Text>
          </View>
        </View>
