...
export default function LogicII() {
  ...
  const courseInfo = {
    ...
    description: "Dive deeper into advanced logical concepts. Master predicate logic, quantifiers, logical proofs, and formal reasoning systems."
  };
  ...
  const courseContent: CourseContent[] = [
    {
      ...
      type: "video",
      duration: "15:00",
      description: "Introduction to predicates, quantifiers, and their applications",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "20 min",
      description: "Learn to work with ∀ and ∃ quantifiers in logical statements",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "18:30",
      description: "Master different proof techniques and strategies",
      completed: false,
    },
    {
      ...
      type: "exercise",
      duration: "25 min",
      description: "Practice constructing formal proofs using natural deduction",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "22 min",
      description: "Explore the relationship between set theory and logical reasoning",
      completed: false,
    },
    {
      title: "Final Project: Formal Proof System",
      type: "project",
      duration: "45 min",
      description: "Design and implement a simple formal proof system",
      completed: false,
    }
  ];
  ...
  const learningPoints = [
    "Master predicate logic and quantifiers",
    "Construct and evaluate formal proofs",
    "Apply natural deduction techniques",
    "Understand set theory applications in logic",
    "Develop formal reasoning systems"
  ];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}> 
          <FontAwesome5 name="chess-knight" size={60} color="#000" style={styles.bannerIcon} />
          <View style={styles.bannerContent}>
            <Text style={styles.bannerTitle}>Logic II</Text>
            <Text style={styles.bannerSubtitle}>Advanced Logical Reasoning</Text>
          </View>
        </View>
