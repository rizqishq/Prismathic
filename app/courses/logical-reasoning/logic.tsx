...
export default function Logic() {
  ...
  const courseInfo = {
    ...
    description: "Build your logical reasoning skills. Learn about statements, truth tables, logical connectives, and how to construct valid arguments."
  };
  ...
  const courseContent: CourseContent[] = [
    {
      ...
      type: "video",
      duration: "10:00",
      description: "Overview of logic and its importance in reasoning",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "15 min",
      description: "Learn about logical statements and how to determine their truth values",
      completed: false,
    },
    {
      ...
      type: "video",
      duration: "12:30",
      description: "Explore AND, OR, NOT, IF-THEN, and IF-AND-ONLY-IF connectives",
      completed: false,
    },
    {
      title: "Truth Tables",
      type: "exercise",
      duration: "20 min",
      description: "Practice constructing and analyzing truth tables",
      completed: false,
    },
    {
      ...
      type: "reading",
      duration: "18 min",
      description: "Understand how to build and evaluate logical arguments",
      completed: false,
    },
    {
      title: "Final Project: Logical Puzzles",
      type: "project",
      duration: "30 min",
      description: "Solve and create your own logical puzzles",
      completed: false,
    }
  ];
  ...
  const learningPoints = [
    "Understand the basics of logic and reasoning",
    "Analyze statements and their truth values",
    "Use logical connectives to build complex statements",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.bannerContainer, {backgroundColor: courseInfo.color}]}> 
          <FontAwesome5 name="chess" size={60} color="#000" style={styles.bannerIcon} />
          <View style={styles.bannerContent}>
            <Text style={styles.bannerTitle}>Logic</Text>
            <Text style={styles.bannerSubtitle}>Sharpen your reasoning skills</Text>
          </View>
        </View>
